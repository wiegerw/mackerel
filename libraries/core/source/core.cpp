...
const atermpp::function_symbol core::detail::function_symbols::BooleanOr = core::detail::function_symbol_BooleanOr();
  ...
  const atermpp::function_symbol core::detail::function_symbols::VariableUpdate = core::detail::function_symbol_VariableUpdate();
...
const atermpp::aterm_appl core::detail::default_values::BooleanOr = core::detail::default_value_BooleanOr();
  ...
  const atermpp::aterm_appl core::detail::default_values::VariableUpdate = core::detail::default_value_VariableUpdate();
