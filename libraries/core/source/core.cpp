...
const atermpp::function_symbol core::detail::function_symbols::BooleanOr = core::detail::function_symbol_BooleanOr();
  ...
  const atermpp::function_symbol core::detail::function_symbols::VariableAssignment = core::detail::function_symbol_VariableAssignment();
  ...
  const atermpp::function_symbol core::detail::function_symbols::UntypedVariableAssignment = core::detail::function_symbol_UntypedVariableAssignment();
...
const atermpp::aterm_appl core::detail::default_values::BooleanOr = core::detail::default_value_BooleanOr();
  ...
  const atermpp::aterm_appl core::detail::default_values::VariableAssignment = core::detail::default_value_VariableAssignment();
  ...
  const atermpp::aterm_appl core::detail::default_values::UntypedVariableAssignment = core::detail::default_value_UntypedVariableAssignment();
