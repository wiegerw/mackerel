...
variable_assignment(const core::identifier_string& name, const sort_expression& sort, const assignment_list& assignments) : public data::data_expression | EO    | VariableAssignment        | A variable assignment
...
untyped_variable_assignment(const core::identifier_string& name, const untyped_identifier_assignment_list& assignments)   : public data::data_expression | EO    | UntypedVariableAssignment | An untyped variable assignment
'''
