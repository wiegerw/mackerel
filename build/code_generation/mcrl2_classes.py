...
variable_assignment(const core::identifier_string& name, const sort_expression& sort, const data_assignment_list& assignments) : public data::data_expression | EO    | VariableAssignment | A variable assignment
